        ...
        for ( var teacherkey in student.teachers ) {
          ...
          if ( emails.Teachers[ teacher.name ] ) {
            transport.sendMail( {
              ...
              html: req.user.google.name + ' in your period ' + teacher.period + ' class has requested your approval for early leave on ' + note.excused_date + '<br><a href="stuyabsence.stuycs.org/teacher/note/"' + note._id + '">View Early Excuse Note</a>'
            } );
          }
        }
